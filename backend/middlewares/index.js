...
middleware.validateAdminPostSchoolAuth = [
    ...
    body('password', 'Min lenght is 8').trim().not().isEmpty().isLength({ min: 8 }),
...
middleware.validateAdminPutDeleteSchoolAuth = [
    ...
    body('password', 'Min lenght is 8').trim().isLength({ min: 8 }),
...
middleware.validateStudentPost = [
    ...
    body('password', 'Must be between 8 to 12 characters').trim().not().isEmpty().isLength({min: 8, max: 12}),
